    ...
    if (!shouldSkip) {
        input.forEach(middle => {
            if (!shouldSkip) {
                input.forEach(last => {
                    if (!shouldSkip) {
                        if (parseInt(first) + parseInt(middle) + parseInt(last) == 2020) {
